...
cd Debug
conan install ../.. --output-folder=. --build=missing -pr:b=clang -pr:h=clang --update -c tools.system.package_manager:mode=install -c tools.system.package_manager:sudo=True -s build_type=Debug
cd ../..
